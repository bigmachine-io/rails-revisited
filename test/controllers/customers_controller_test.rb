...
class CustomersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create customer" do
    assert_difference("Customer.count") do
      post customers_url, params: { customer: { address: @customer.address, city: @customer.city, company: @customer.company, country: @customer.country, email: @customer.email, fax: @customer.fax, first_name: @customer.first_name, last_name: @customer.last_name, phone: @customer.phone, postal_code: @customer.postal_code, state: @customer.state } }
    end
